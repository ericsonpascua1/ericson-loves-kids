...
module.exports["run"] = async ({ api, event, args, Users }) => {
  try {
    ...
    if (query) {
      ...
      const apiUrl = `https://liaspark.chatbotcommunity.ltd/@nealianacagara/api/taylor?userName=${encodeURIComponent(name)}&key=j86bwkwo-8hako-12C&query=${encodeURIComponent(query)}`;
